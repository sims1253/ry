...
| :---- | :----------------------- | :------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RY000 | syntax-error             | error    | Unparseable input, or input base R's parser rejects (such as an invalid native-pipe right-hand side). A recovered tree reports only its RY000s; diagnostics derived from parser repair are unreliable.    |
