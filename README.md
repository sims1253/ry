...
#> /tmp/ry-readme/parallel.R:5:8: error: [RY080] `map_dbl` requires a scalar `double` callback result, but the callback returns `character<len=1>`; R rejects this result
