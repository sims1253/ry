...
| :-- | :-- | :-- | ---: | :-- | :-- |
| [`tidyverse-0.7.1.json`](tidyverse-0.7.1.json) | 0.9 dev | 24 | 75 | 11 / 41 / 0 (+23 unowned) | hermetic (strict CI gate) |
| [`posit-0.9.0.json`](posit-0.9.0.json) | 0.9 dev | 62 | 392 | 38 / 354 / 0 | hermetic (strict CI gate) |
