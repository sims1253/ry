...
| :-- | :-- | :-- | ---: | :-- | :-- |
| [`tidyverse-0.7.1.json`](tidyverse-0.7.1.json) | 0.9 dev | 24 | 105 | 10 / 43 / 0 (+52 unowned) | hermetic (strict CI gate) |
| [`posit-0.9.0.json`](posit-0.9.0.json) | 0.9 dev | 62 | 530 | 43 / 487 / 0 | hermetic (strict CI gate) |
