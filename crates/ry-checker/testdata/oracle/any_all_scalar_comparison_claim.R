...
# base result is not NA" (S4 dispatch, which can leave the domain
# entirely, is qualified in the message and witnessed in the hardening
# evidence, not here -- fixtures stay side-effect-free). None is the
