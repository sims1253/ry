...
module.exports = grammar({
  ...
  rules: {
    ...
    // R lexes `[[` as one token but closes it with two independent `]` tokens.
    // Keeping them separate preserves comments and newlines between them.
    _close_bracket2: $ => seq(
      alias($._external_close_bracket2, "]"),
      $._close_bracket
    )
  }
})
