...
stopifnot(!exists("if_else", where = asNamespace("vctrs"), inherits = FALSE))
stopifnot(!"if_else" %in% getNamespaceExports("vctrs"))
stopifnot("vec_if_else" %in% getNamespaceExports("vctrs"))
